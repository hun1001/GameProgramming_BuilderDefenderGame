...
public class EnemyWaveUI : MonoBehaviour
{
    ...
    private void HandleEnemyWaveSpawnPositionIndicator()
    {
        ...
        float distanceToNextSpwnPosition = Vector3.Distance(enemyWaveManager.GetSpawnPosition(), mainCamera.transform.position);
        enemyWaveSpawnPositionIndicator.gameObject.SetActive(distanceToNextSpwnPosition > mainCamera.orthographicSize * 1.5f);
    }
